...
terminal_bc = @(t, x, u, p) [x(1:4) - x_f(p(1) + p(2)); 0];
...
[venus_GA_phase_transition.convex_constraints, venus_GA_phase_transition.nonconvex_constraints, original_constraints] = construct_GA_constraints(venus_GA_transition_k, t_k, mu_venus, R_venus, x_venus, nr, v_scale_ref);

function [CasADi_sol] = CasADi_solve_mass_convexified_freetf(x_initial, x_guess, u_guess, p_guess, vehicle, N, delta_t, glideslope_angle_max)
...
for i = 1:(N-1)
    ...
    x_next = rk4(@(t, x, u, p) SymDynamics3DoF_mass_convexified_freetf(t, x, u, p, vehicle.L, vehicle.I(2), vehicle.alpha), delta_t * (i - 1), x_current, @(t) u_current, 0, delta_t);
...
x0 = opti.parameter(7, 1);
opti.set_value(x0, x_initial);

function [z_star, what_star, sol_info] = PIPG_orig_precond_Dexplicit(qhat, Hhat, h, Dball, Dsingleton, L, L_inv, lambda, sigma, rho, tol_abs, tol_rel, tol_infeas, j_check, j_restart, j_max, z_ref, what_ref, S_z, c_z)
...
for j = 1 : j_max
    ...
    zhat_jp1 = Dball.project(1 : N, S_z * (L_inv * (zhat_j - alpha_j * (lambda * zhat_j + qhat + Hhat' * what_jp1))) + c_z);
    zhat_jp1 = L * (S_z \ (Dsingleton.project(1 : N, zhat_jp1) - c_z));
    % 

function [z_star, what_star, sol_info] = PIPG_scaled(qhat, Hhat, h, D, L, L_inv, lambda, sigma, rho, tol_abs, tol_rel, tol_infeas, j_check, j_max, z_ref, what_ref, S_z, c_z, t_k, glideslope_angle_max, gimbal_max, T_min, T_max)

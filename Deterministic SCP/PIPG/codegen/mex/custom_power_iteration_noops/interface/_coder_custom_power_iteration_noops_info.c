 ...
 *
 * _coder_custom_power_iteration_noops_info.c
 *
...
/* Include files */
#include "_coder_custom_power_iteration_noops_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "QualifiedName",
                emlrtMxCreateString("custom_power_iteration_noops"));
  ...
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739775.62431712961));
...
/* End of code generation (_coder_custom_power_iteration_noops_info.c) */

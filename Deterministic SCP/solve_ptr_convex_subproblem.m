...
sol_info.J_tr = trust_region_cost(eta, p, ptr_ops.w_tr, ptr_ops.w_tr_p);
sol_info.J_vc = virtual_control_cost(V, v_prime, v_0, v_N, ptr_ops.w_vc);
sol_info.dJ = 100 * (prob.objective(prob.unscale_x(X), prob.unscale_u(U), prob.unscale_p(p), prob.unscale_x(x_ref), prob.unscale_u(u_ref), prob.unscale_p(p_ref)) - prob.objective(prob.unscale_x(x_ref), prob.unscale_u(u_ref), prob.unscale_p(p_ref), prob.unscale_x(x_ref), prob.unscale_u(u_ref), prob.unscale_p(p_ref))) / prob.objective(prob.unscale_x(x_ref), prob.unscale_u(u_ref), prob.unscale_p(p_ref), prob.unscale_x(x_ref), prob.unscale_u(u_ref), prob.unscale_p(p_ref));

...
max_gimbal_constraint_linearized_STC = {round(N / 2) : N, @(t, x, u, p, x_ref, u_ref, p_ref, k) (gimbal_func_linearized(t, x, u, p, x_ref, u_ref, p_ref, k) - gimbal_max_final ^ 2) * (x_ref(3, k) <= gimbal_STC_trigger_height)};
...
control_nonconvex_constraints = {max_gimbal_constraint_linearized, max_thrust_rate_constraint, max_gimbal_rate_constraint_linearized, max_gimbal_constraint_linearized_STC};
...
terminal_bc = @(x, p, x_ref, p_ref) [x(1:13) - x_f(1:13); 0];

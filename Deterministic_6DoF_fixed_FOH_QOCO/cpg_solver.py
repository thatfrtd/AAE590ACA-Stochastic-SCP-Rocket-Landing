...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    if updated_params is None:
        updated_params = ["x_ref", "u_ref", "Ak_0", "Bk_minus_0", "Bk_plus_0", "ck", "Ak_1", "Bk_minus_1", "Bk_plus_1", "Ak_2", "Bk_minus_2", "Bk_plus_2", "Ak_3", "Bk_minus_3", "Bk_plus_3", "Ak_4", "Bk_minus_4", "Bk_plus_4", "Ak_5", "Bk_minus_5", "Bk_plus_5", "Ak_6", "Bk_minus_6", "Bk_plus_6", "Ak_7", "Bk_minus_7", "Bk_plus_7", "Ak_8", "Bk_minus_8", "Bk_plus_8", "x_0", "x_f"]
    ...
    prob.var_dict['X'].save_value(np.array(res.cpg_prim.X).reshape((14, 10), order='F'))
    prob.var_dict['U'].save_value(np.array(res.cpg_prim.U).reshape((4, 10), order='F'))
    prob.var_dict['V'].save_value(np.array(res.cpg_prim.V).reshape((14, 9), order='F'))
    ...
    prob.constraints[9].save_dual_value(np.array(res.cpg_dual.d9).reshape(10))
    prob.constraints[10].save_dual_value(np.array(res.cpg_dual.d10).reshape(10))
    prob.constraints[11].save_dual_value(np.array(res.cpg_dual.d11).reshape(10))
    prob.constraints[12].save_dual_value(np.array(res.cpg_dual.d12).reshape(10))
    prob.constraints[13].save_dual_value(np.array(res.cpg_dual.d13).reshape(10))
    prob.constraints[14].save_dual_value(np.array(res.cpg_dual.d14))
    prob.constraints[15].save_dual_value(np.array(res.cpg_dual.d15).reshape(8))
    prob.constraints[16].save_dual_value(np.array(res.cpg_dual.d16).reshape((14, 14), order='F'))
    prob.constraints[17].save_dual_value(np.array(res.cpg_dual.d17).reshape((13, 13), order='F'))
...
def cpg_gradient(prob, gradient_sol_primal=None, gradient_sol_dual=None):
    ...
    if gradient_sol_primal is not None and gradient_sol_dual is not None:
        ...
        gradient_sol.primal = [0] * 717
        gradient_sol.dual = [0] * 1224
        use_sol = False
    ...
    prob.param_dict['x_ref'].gradient = np.array(pdelta.x_ref).reshape((14, 10), order='F')
    prob.param_dict['u_ref'].gradient = np.array(pdelta.u_ref).reshape((4, 10), order='F')
    ...
    prob.param_dict['ck'].gradient = np.array(pdelta.ck).reshape((14, 9), order='F')

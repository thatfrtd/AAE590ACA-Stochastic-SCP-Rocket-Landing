...
from Deterministic_6DoF_fixed_FOH_QOCO import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    if updated_params is None:
        updated_params = ["x_ref", "u_ref", "Ak_0", "Bk_minus_0", "Bk_plus_0", "ck", "Ak_1", "Bk_minus_1", "Bk_plus_1", "Ak_2", "Bk_minus_2", "Bk_plus_2", "Ak_3", "Bk_minus_3", "Bk_plus_3", "Ak_4", "Bk_minus_4", "Bk_plus_4", "Ak_5", "Bk_minus_5", "Bk_plus_5", "Ak_6", "Bk_minus_6", "Bk_plus_6", "Ak_7", "Bk_minus_7", "Bk_plus_7", "Ak_8", "Bk_minus_8", "Bk_plus_8", "Ak_9", "Bk_minus_9", "Bk_plus_9", "Ak_10", "Bk_minus_10", "Bk_plus_10", "Ak_11", "Bk_minus_11", "Bk_plus_11", "Ak_12", "Bk_minus_12", "Bk_plus_12", "Ak_13", "Bk_minus_13", "Bk_plus_13", "x_0", "x_f"]
    ...
    par.x_f = list(param_dict["x_f"].value.flatten(order="F"))
    ...
    prob.var_dict['X'].save_value(np.array(res.cpg_prim.X).reshape((14, 15), order='F'))
    prob.var_dict['U'].save_value(np.array(res.cpg_prim.U).reshape((4, 15), order='F'))
    prob.var_dict['V'].save_value(np.array(res.cpg_prim.V).reshape((14, 14), order='F'))
    prob.var_dict['v_0'].save_value(np.array(res.cpg_prim.v_0).reshape((14, 1), order='F'))
    prob.var_dict['v_N'].save_value(np.array(res.cpg_prim.v_N).reshape((13, 1), order='F'))
    ...
    prob.constraints[2].save_dual_value(np.array(res.cpg_dual.d2).reshape(14))
    prob.constraints[3].save_dual_value(np.array(res.cpg_dual.d3).reshape(14))
    prob.constraints[4].save_dual_value(np.array(res.cpg_dual.d4).reshape(14))
    prob.constraints[5].save_dual_value(np.array(res.cpg_dual.d5).reshape(14))
    prob.constraints[6].save_dual_value(np.array(res.cpg_dual.d6).reshape(14))
    prob.constraints[7].save_dual_value(np.array(res.cpg_dual.d7).reshape(14))
    prob.constraints[8].save_dual_value(np.array(res.cpg_dual.d8).reshape(14))
    prob.constraints[9].save_dual_value(np.array(res.cpg_dual.d9).reshape(14))
    prob.constraints[10].save_dual_value(np.array(res.cpg_dual.d10).reshape(14))
    prob.constraints[11].save_dual_value(np.array(res.cpg_dual.d11).reshape(14))
    prob.constraints[12].save_dual_value(np.array(res.cpg_dual.d12).reshape(14))
    ...
    prob.constraints[20].save_dual_value(np.array(res.cpg_dual.d20).reshape(13))
    prob.constraints[21].save_dual_value(np.array(res.cpg_dual.d21).reshape((14, 14), order='F'))
    prob.constraints[22].save_dual_value(np.array(res.cpg_dual.d22).reshape((13, 13), order='F'))
...
def cpg_gradient(prob, gradient_sol_primal=None, gradient_sol_dual=None):
    ...
    if gradient_sol_primal is not None and gradient_sol_dual is not None:
        ...
        gradient_sol.primal = [0] * 1062
        gradient_sol.dual = [0] * 1649
        use_sol = False
    ...
    prob.param_dict['x_ref'].gradient = np.array(pdelta.x_ref).reshape((14, 15), order='F')
    prob.param_dict['u_ref'].gradient = np.array(pdelta.u_ref).reshape((4, 15), order='F')
    prob.param_dict['Ak_0'].gradient = np.array(pdelta.Ak_0).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_0'].gradient = np.array(pdelta.Bk_minus_0).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_0'].gradient = np.array(pdelta.Bk_plus_0).reshape((14, 4), order='F')
    prob.param_dict['ck'].gradient = np.array(pdelta.ck).reshape((14, 14), order='F')
    prob.param_dict['Ak_1'].gradient = np.array(pdelta.Ak_1).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_1'].gradient = np.array(pdelta.Bk_minus_1).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_1'].gradient = np.array(pdelta.Bk_plus_1).reshape((14, 4), order='F')
    prob.param_dict['Ak_2'].gradient = np.array(pdelta.Ak_2).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_2'].gradient = np.array(pdelta.Bk_minus_2).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_2'].gradient = np.array(pdelta.Bk_plus_2).reshape((14, 4), order='F')
    prob.param_dict['Ak_3'].gradient = np.array(pdelta.Ak_3).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_3'].gradient = np.array(pdelta.Bk_minus_3).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_3'].gradient = np.array(pdelta.Bk_plus_3).reshape((14, 4), order='F')
    prob.param_dict['Ak_4'].gradient = np.array(pdelta.Ak_4).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_4'].gradient = np.array(pdelta.Bk_minus_4).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_4'].gradient = np.array(pdelta.Bk_plus_4).reshape((14, 4), order='F')
    prob.param_dict['Ak_5'].gradient = np.array(pdelta.Ak_5).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_5'].gradient = np.array(pdelta.Bk_minus_5).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_5'].gradient = np.array(pdelta.Bk_plus_5).reshape((14, 4), order='F')
    prob.param_dict['Ak_6'].gradient = np.array(pdelta.Ak_6).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_6'].gradient = np.array(pdelta.Bk_minus_6).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_6'].gradient = np.array(pdelta.Bk_plus_6).reshape((14, 4), order='F')
    prob.param_dict['Ak_7'].gradient = np.array(pdelta.Ak_7).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_7'].gradient = np.array(pdelta.Bk_minus_7).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_7'].gradient = np.array(pdelta.Bk_plus_7).reshape((14, 4), order='F')
    prob.param_dict['Ak_8'].gradient = np.array(pdelta.Ak_8).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_8'].gradient = np.array(pdelta.Bk_minus_8).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_8'].gradient = np.array(pdelta.Bk_plus_8).reshape((14, 4), order='F')
    prob.param_dict['Ak_9'].gradient = np.array(pdelta.Ak_9).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_9'].gradient = np.array(pdelta.Bk_minus_9).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_9'].gradient = np.array(pdelta.Bk_plus_9).reshape((14, 4), order='F')
    prob.param_dict['Ak_10'].gradient = np.array(pdelta.Ak_10).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_10'].gradient = np.array(pdelta.Bk_minus_10).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_10'].gradient = np.array(pdelta.Bk_plus_10).reshape((14, 4), order='F')
    prob.param_dict['Ak_11'].gradient = np.array(pdelta.Ak_11).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_11'].gradient = np.array(pdelta.Bk_minus_11).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_11'].gradient = np.array(pdelta.Bk_plus_11).reshape((14, 4), order='F')
    prob.param_dict['Ak_12'].gradient = np.array(pdelta.Ak_12).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_12'].gradient = np.array(pdelta.Bk_minus_12).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_12'].gradient = np.array(pdelta.Bk_plus_12).reshape((14, 4), order='F')
    prob.param_dict['Ak_13'].gradient = np.array(pdelta.Ak_13).reshape((14, 14), order='F')
    prob.param_dict['Bk_minus_13'].gradient = np.array(pdelta.Bk_minus_13).reshape((14, 4), order='F')
    prob.param_dict['Bk_plus_13'].gradient = np.array(pdelta.Bk_plus_13).reshape((14, 4), order='F')
    prob.param_dict['x_0'].gradient = np.array(pdelta.x_0).reshape((14, 1), order='F')
    prob.param_dict['x_f'].gradient = np.array(pdelta.x_f).reshape((13, 1), order='F')

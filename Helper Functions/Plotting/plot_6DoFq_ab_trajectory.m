function [] = plot_6DoFq_ab_trajectory(t, x, u, glideslope_angle, gimbal_max, T_min, T_max, options)
arguments
    t
    x 
    u 
...
cmap = colormap;
u_color = interp1(linspace(T_min / T_max, 1, size(cmap, 1)), cmap, u(1, :) / T_max, "linear", "extrap");

gimbal_angle = vecnorm(u(2:3, :));

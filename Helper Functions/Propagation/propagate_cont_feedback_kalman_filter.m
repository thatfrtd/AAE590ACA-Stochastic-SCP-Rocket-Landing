function [t_sub, x_array, xhat_array, Phat_array] = propagate_cont_feedback_kalman_filter(x_0, P_0, u, f, G, A_ref, B_ref, c_ref, G_ref, L_k, C_k, D_k, f_0, g_0, t_k, tspan, N_sub, w_k, v_k, tolerances)

function [CasADi_sol] = CasADi_solve_6DoF_Quaternion(x_initial, x_final, x_guess, u_guess, vehicle, N, delta_t, glideslope_angle_max)
...
for i = 1:(N-1)
    ...
    x_next = rk4(@(t, x, u, p) SymDynamics6DoF_q(x, u, [g; vehicle.m; vehicle.L; vehicle.I]), delta_t * (i - 1), x_current, @(t) u_current, 0, delta_t);

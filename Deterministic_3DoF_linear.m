...
final_thrust_constraint = {N, @(t, x, u, p) norm(u(1:3)) - u(3) / cosd(5)};
thrust_angle_constraint = {1:N, @(t, x, u, p) norm(u(1:3)) - u(3) / cosd(70)};
thrust_min_constraint = {1:N, @(t, x, u, p) T_min * exp(-x(7)) * cosd(70) - u(3)};
control_convex_constraints = {min_thrust_constraint,max_thrust_constraint,lcvx_thrust_constraint,thrust_min_constraint,thrust_angle_constraint,final_thrust_constraint};
